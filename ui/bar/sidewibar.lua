...
-- local language_layout = require ("ui.widgets.language_layout")

-- local language_value = io.popen("xkb-switch -p -n"):read("*a")
-- local language_layout = wibox.widget {
--     font = beautiful.icon_font_name .. "12",
--     align = "center",
--     valign = "center",
--     widget = wibox.widget.textbox,
    ...
    s.mywibox.widget = wibox.widget {
        {
            ...
            {wrap_widget(s.mytaglist), widget = wibox.container.constraint},
            {
				...
				wrap_widget(language_layout.widget),	
